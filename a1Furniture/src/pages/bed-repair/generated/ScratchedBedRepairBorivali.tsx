...
/**
 * Location+Problem page: /scratched-bed-repair-borivali
 * Keyword: scratched bed repair borivali
 */
const ScratchedBedRepairBorivali: React.FC = () => {
...
export default ScratchedBedRepairBorivali;
