...
const pageData: PageData = {
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://a1furniturepolish.com/services/best-duco-polish-mumbai",
...
const BestDucoPolishMumbai: React.FC = () => {
  return <ServicePageTemplate pageData={pageData} />;
};

export default BestDucoPolishMumbai;
