...
const pageData: PageData = {
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://a1furniturepolish.com/services/best-cabinet-wood-polish-mumbai",
...
const BestCabinetWoodPolishMumbai: React.FC = () => {
  return <ServicePageTemplate pageData={pageData} />;
};

export default BestCabinetWoodPolishMumbai;
