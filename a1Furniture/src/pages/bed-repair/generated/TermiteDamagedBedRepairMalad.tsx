...
/**
 * Location+Problem page: /termite-damaged-bed-repair-malad
 * Keyword: termite damaged bed repair malad
 */
const TermiteDamagedBedRepairMalad: React.FC = () => {
...
export default TermiteDamagedBedRepairMalad;
