...
const pageData: PageData = {
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://a1furniturepolish.com/services/best-wooden-floor-polishing-mumbai",
...
const BestWoodenFloorPolishingMumbai: React.FC = () => {
  return <ServicePageTemplate pageData={pageData} />;
};

export default BestWoodenFloorPolishingMumbai;
