...
export const furnitureProducts: FurnitureProduct[] = [
  ...
  // ═══════════════════════════════════════
  {
    ...
    colorVariants: makeColorVariants('/products/sofa/1_seater_sofa', 'darkBrownSingleSofa.webp', 'lightBrownSingleSofa.webp', 'whiteSingleSofa.webp'),
  ...
  },
  {
    ...
    colorVariants: makeColorVariants('/products/sofa/2_seater', 'darkBrownDouble.webp', 'lightBrownDoubleSofa.webp', 'whiteDoubleSofa.webp'),
    features: ['6 Months Warranty', 'Premium polish', 'Scratch removal'],
    isBestSeller: true,
  },
  {
    ...
    colorVariants: makeColorVariants('/products/sofa/3_seater', 'darkBrownTripleSofa.webp', 'lightBrownTripleSofa.webp', 'whiteTripleSeater.webp'),
