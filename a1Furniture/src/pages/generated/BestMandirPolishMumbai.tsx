...
const pageData: PageData = {
  ...
  "schema": {
    "localBusiness": {
      ...
      "url": "https://a1furniturepolish.com/services/best-mandir-polish-mumbai",
...
const BestMandirPolishMumbai: React.FC = () => {
  return <ServicePageTemplate pageData={pageData} />;
};

export default BestMandirPolishMumbai;
