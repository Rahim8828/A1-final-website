...
/**
 * Location+Problem page: /scratched-bed-repair-thane
 * Keyword: scratched bed repair thane
 */
const ScratchedBedRepairThane: React.FC = () => {
...
export default ScratchedBedRepairThane;
