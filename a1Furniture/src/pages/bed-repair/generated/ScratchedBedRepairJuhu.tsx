...
/**
 * Location+Problem page: /scratched-bed-repair-juhu
 * Keyword: scratched bed repair juhu
 */
const ScratchedBedRepairJuhu: React.FC = () => {
...
export default ScratchedBedRepairJuhu;
